...
editing. HIL actions are explicit: `/approve --report-file final.md` submits
human approval and `/publish-final --report-file final.md` retries final
publishing for an already approved run.
